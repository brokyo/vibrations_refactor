    ...
    options: [
      {
        type: "long",
        text:
          "Reality, then, is not found in the mundane mundane things we call things real."
      },
      {
        type: "short",
        text: "Reality is \n\nthe way it is."
      },
      {
        type: "short",
        text:
          "Reality is such a small thing in this chain of events that we should not get too attached to it"
      },
      {
        type: "short",
      ...
      },
      {
        type: "short",
        text:
          "Reality is in flux, there is life, try, try, try, try, try, try, try, try, try, try"
      },
      {
        type: "short",
    ...
    options: [
      {
        type: "long",
        text:
          "You will know its true colours. The Tower of Babel will not be discovered until all the coloured stones have been discovered."
      },
      {
        type: "long",
        text:
          "You will know that Legend is real\n\nWhen you can feel the vibrations\nWhen you can hear the music\nWhen you become attuned\nTo the vibrations\nIn your head"
      },
      {
        type: "short",
    ...
    options: [
      {
        type: "short",
        text:
          "A lesson: don't panic\n\n There is no right or wrong way to do it. It all depends on your situation.\n"
      },
      {
        type: "short",
        text:
          "A lesson: “I can’t fly” because it’s hard\nAnd the lesson: get used to flying\n"
      },
      {
        type: "short",
        text:
          "A lesson: don't get caught up in the scheme of things. Be open to new experiences.\nDon't give up on life. \n"
      },
      {
        type: "long",
        text:
      ...
      },
      {
        type: "long",
        text:
          "A lesson: Open your eyes. Hold your head back. Feel and see everything. Feel for a few moments. Then let loose a great sound. \n"
      },
      {
        type: "short",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        type: "short",
        text:
          "Koan: 'Let's make a world where everything is going to be alright.'"
      },
      {
        type: "short",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        type: "short",
        text:
          "Let go of your telescopes,\ngrab the stars,\n and follow them like meteors fall from the sky."
      },
      {
        type: "short",
        text:
          "Let go of your visualization techniques. They're just techniques.\n"
      },
      {
        type: "long",
        text:
          "Let go of what you have created, and let go of all the illusions and worries that keep you from being present in the truth.\nLet go of all the illusions and worries that keep you from being present in the truth that is Truth.\n"
      },
      {
        type: "short",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        type: "short",
        text:
          "It has been said that the human speaker, like all other atoms, is made up of \n\nspontaneous forms\n"
      },
      {
        type: "long",
        text:
      ...
      },
      {
        type: "long",
        text:
          "It has been said that there is no such thing as 'sound' only 'being'; that we are all parts of the same universal\nforce, and that force and form are, in reality, an adaptation of the same universal essence."
      }
    ]
  }
];
